        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <div>
              ...
              >
                <option value="PAID">Paid (Pending Work)</option>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
          ...
          <p className="text-gray-600">
            {statusFilter === 'COMPLETED'
              ? 'No completed walk-in nurse service orders found.'
              : statusFilter === 'ALL'
                ? 'No walk-in nurse service orders found.'
                : 'No paid walk-in nurse service orders available at the moment.'}
          </p>
        </div>
      ) : (
              ...
              <div className="p-6">
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                    order.status === 'COMPLETED' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800'
                  }`}>
